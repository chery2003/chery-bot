...
module.exports.run = function({ api, event, args, client, __GLOBAL }) {
	...
	if (!command) {
		...
		return api.sendMessage(msg + `[ Sử dụng: "${(threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : __GLOBAL.settings.PREFIX}help để xem lệnh! | Hiện tại đang có ${client.commands.size} lệnh có thể sử dụng trên bot này ]`, event.threadID);
